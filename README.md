...
> Après l'[installation](docs/installation.md), consultez [comment lancer le logiciel](docs/lancement.md), puis le [tutoriel pas à pas](docs/tutoriel.md) et le [guide des clés IA](docs/cles-api.md).
